...
void construct_MSG_LON(uint8_t **output, uint8_t SOF, uint8_t Team_ID[3], float lon);
void construct_MSG_LAT(uint8_t **output, uint8_t SOF, uint8_t Team_ID[3], float lat);
